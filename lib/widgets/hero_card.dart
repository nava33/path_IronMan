      ...
      child: Stack(
        children: <Widget>[
          ...
          Align(
            ...
            child: Padding(
              padding: EdgeInsets.only(top: MediaQuery.of(context).size.width * 0.8 * 0.5),
              child: Hero(
                tag: 'image_hero',
                child: Image.asset(
                  'assets/iron_man.png',
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  ...
                  style: TextStyle(color: Colors.white70, fontWeight: FontWeight.bold, fontSize: 18, letterSpacing: 2),
                ),
              ],
            ),
          ),
